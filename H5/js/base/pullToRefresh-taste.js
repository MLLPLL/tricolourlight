...
var refresher = {
	...
	init: function(parameter) {
		...
		pullUpLabel.className = "pullUpLabel lightBlue";
		...
		var pullUpP = document.createElement("div");
		pullUpP.className = "more-taste";
		var content = document.createTextNode(refresher.info.pullUpP);
		pullUpP.appendChild(content);
		pullUp.appendChild(pullUpP);
